...
urlpatterns = [
    ...
    path('posts/<int:pk>/comments/', AddCommentView.as_view(), name='add-comment'),  # Komentowanie wpisów
    ...
    path('posts/<int:pk>/comments/<int:comment_id>/delete/', DeleteCommentView.as_view(), name='delete-comment'),  # Zarządzanie komentarzami
]
