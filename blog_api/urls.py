...
urlpatterns = [
    ...
    path('posts/<int:post_id>/comments', DisplayCommentView.as_view(), name='display-comments'),
    ## Wyświetlanie komentarzy
    path('posts/<int:pk>/addcomment', CreateCommentView.as_view(), name='add-comment'),  ## Komentowanie wpisów
    ...
    path('posts/<int:pk>/comments/<int:comment_id>/edit', EditCommentView.as_view(), name='edit-comment'),
    ## Edycja komentarza
]
